document.addEventListener("DOMContentLoaded", async () => {
  ...
  const routes = {
    ...
    "/dashboard/create-celebrity": `${baseUrl}/pages/admin/create-celebrity/step1.html`,
    "/dashboard/create-celebrity/create-events": `${baseUrl}/pages/admin/create-celebrity/step2.html`,
    "/dashboard/create-celebrity/preview": `${baseUrl}/pages/admin/create-celebrity/step3.html`,
